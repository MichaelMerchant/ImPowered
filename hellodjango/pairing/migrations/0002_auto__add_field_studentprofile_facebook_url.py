...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'StudentProfile.facebook_url'
        db.add_column('pairing_studentprofile', 'facebook_url', self.gf('django.db.models.fields.CharField')(default='', max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'StudentProfile.facebook_url'
        db.delete_column('pairing_studentprofile', 'facebook_url')
    ...
    models = {
        ...
        'pairing.project': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'student': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'projects'", 'to': "orm['pairing.StudentProfile']"})
        },
