...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('pairing_project', 'name', self.gf('django.db.models.fields.CharField')(default='ICS21', max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Project.name'
        db.delete_column('pairing_project', 'name')
