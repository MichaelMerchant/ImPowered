...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Skill.parent'
        db.add_column('impowered_skill', 'parent', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='parent_skill', null=True, to=orm['impowered.Skill']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Skill.parent'
        db.delete_column('impowered_skill', 'parent_id')
