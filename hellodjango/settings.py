...
ADMINS = (
     ('mimercha', 'merchant.michael@gmail.com'),
)
...
DATABASES = {
    'default': {
        ...
        'NAME': 'impowered',                      # Or path to database file if using sqlite3.
        'USER': 'dev',                      # Not used with sqlite3.
        'PASSWORD': 'mohandas',                  # Not used with sqlite3.
...
SECRET_KEY = 'o=91y3w&-46*x4=m1qr&_-qyv%13gy!+%29+ftl!)^7yry*lsn'
